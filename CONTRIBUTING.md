...
- Report [new defect](https://github.com/opentiny/tiny-vue-mobile/issues/new?template=bug-report.yml)
- Provide more detailed information for [existing defects](https://github.com/opentiny/tiny-vue-mobile/labels/bug), such as supplementary screenshots, more detailed reproduction steps, minimum reproducible demo links, etc.
...
- Fix defects, you can start with [Good-first issue](https://github.com/opentiny/tiny-vue-mobile/labels/good%20first%20issue).
...
If you encounter problems in the process of using TinyVueMobile components, you are welcome to submit Issue to us. Before submitting Issue, please read the relevant [official documentation](https://opentiny.design) carefully to confirm whether this is a defect or an unimplemented function.

If it is a defect, select [Bug report](https://github.com/opentiny/tiny-vue-mobile/issues/new?template=bug-report.yml) template when creating a new Issue. The title follows the format of `[componentName] defect description`. For example: `[select] filtering function, the selected option cannot be selected again after it has been deleted`.
...
Before submitting pull request, please make sure that your submission is in line with the overall plan of TinyVueMobile. Generally, issues that marked as [bug](https://github.com/opentiny/tiny-vue-mobile/labels/bug) are encouraged to submit pull requests. If you are not sure, you can create a [Discussion](https://github.com/opentiny/tiny-vue-mobile/discussions) for discussion.
...
- Click the Fork button in the upper right corner of the [TinyVueMobile](https://github.com/opentiny/tiny-vue) code repository to Fork the upstream repository to the personal repository.
...
- Open the browser to visit: [http://localhost:3101/](http://localhost:3101/)

```shell
# You need to replace username with your own user name
git clone git@github.com:username/tiny-vue-mobile.git
cd tiny-vue-mobile

# Associate upstream repository
git remote add upstream git@github.com:opentiny/tiny-vue-mobile.git
...
- Make sure that you have completed the steps in local startup and can visit [http://localhost:3101/](http://localhost:3101/) normally.
...
- Open the [Pull requests](https://github.com/opentiny/tiny-vue-mobile/pulls) link of the TinyVueMobile code repository and click the New pull request button to submit the PR.
...
We sincerely thank all the contributors who have participated in the TinyVueMobile project!
...
Due to the current manpower constraints, only information of internal members (or former members) of the TinyVueMobile team is currently being recorded. Open source contributors are welcome to supplement their own information.
